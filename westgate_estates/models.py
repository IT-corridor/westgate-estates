...
class Residential(models.Model):
    ...
    MEDIA_FLOOR_PLAN_00 = models.FileField(null=True, blank=True)
    MEDIA_FLOOR_PLAN_TEXT_00 = models.FileField(null=True, blank=True)
    MEDIA_FLOOR_PLAN_01 = models.FileField(null=True, blank=True)
    MEDIA_FLOOR_PLAN_TEXT_01 = models.FileField(null=True, blank=True)
    MEDIA_IMAGE_60 = models.FileField(null=True, blank=True)
    MEDIA_IMAGE_TEXT_60 = models.FileField(null=True, blank=True)
    MEDIA_IMAGE_61 = models.FileField(null=True, blank=True)
    MEDIA_IMAGE_TEXT_61 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_50 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_TEXT_50 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_51 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_TEXT_51 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_52 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_TEXT_52 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_53 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_TEXT_53 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_00 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_TEXT_00 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_01 = models.FileField(null=True, blank=True)
    MEDIA_DOCUMENT_TEXT_01 = models.FileField(null=True, blank=True)
    MEDIA_VIRTUAL_TOUR_01 = models.FileField(null=True, blank=True)
    MEDIA_VIRTUAL_TOUR_TEXT_01 = models.FileField(null=True, blank=True)
    MEDIA_VIRTUAL_TOUR_02 = models.FileField(null=True, blank=True)
    MEDIA_VIRTUAL_TOUR_TEXT_02 = models.FileField(null=True, blank=True)
